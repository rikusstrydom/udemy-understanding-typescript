...
class ProjectInput extends Component {
    ...
    gatherUserInput() {
        ...
        const validateDescConfig = { value: enteredDescription, required: true, minLength: 5 };
        const validatePeopleConfig = { value: +enteredPeople, required: true, min: 1, max: 5 };
        if (!validate(validateTitleConfig) || !validate(validateDescConfig) || !validate(validatePeopleConfig)) {
            alert('Invalid Input');
            return;
        }
        else {
